  ...
  return (
    <div className="px-6 py-8 max-w-2xl mx-auto space-y-12 pb-24">
      <div className="text-center space-y-4">
        <h2 className="font-serif text-4xl text-primary dark:text-primary tracking-tight transition-colors">The Rules of Engagement</h2>
        <p className="text-zinc-500 dark:text-zinc-400 font-manrope transition-colors">Master the classic puzzle of logic and patience.</p>
      </div>
