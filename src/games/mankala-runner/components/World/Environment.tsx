...
const RetroSun: React.FC = () => {
    ...
    const uniforms = useMemo(() => ({
        uTime: { value: 0 },
        uColorTop: { value: new THREE.Color('#c5a572') }, // Brassy Gold
        uColorBottom: { value: new THREE.Color('#331a00') } // Deep Bronze/Ink
    }), []);
...
export const Environment: React.FC = () => {
  return (
    <>
      ...
      <fog attach="fog" args={['#0a0a0a', 40, 160]} />
      
      <ambientLight intensity={0.2} color="#c5a572" />
      <directionalLight position={[0, 20, -10]} intensity={1.5} color="#c5a572" />
      <pointLight position={[0, 25, -150]} intensity={2} color="#c5a572" distance={200} decay={2} />
